...
function userTripDetails(req, res, next) {
  ...
  _user2.default.findByIdAsync(userId).then(function (userObject) {
    //eslint-disable-line
    var returnObj = {
      success: false,
    ...
    _tripRequest2.default.getUserCount(userType, userId).then(function (totalUserTripRequestRecords) {
      //eslint-disable-line
      ...
      _tripRequest2.default.userList({
        skip: skip, limit: limit, userId: userId, userType: userType
