...
function tripDetails(req, res, next) {
  ...
  _trip2.default.getCount(filter).then(function (totalTripRecords) {
    //eslint-disable-line
    var returnObj = {
      success: false,
...
function createNewTrip(req, res, next) {
  ...
  _user2.default.findAsync({ $or: [{ $and: [{ userType: 'rider' }, { _id: riderId }] }, { $and: [{ userType: 'driver' }, { _id: driverId }] }] }).then(function (foundUserData) {
    //eslint-disable-line
    ...
    tripObj.saveAsync().then(function (newTripObj) {
      ...
      tripRequest.saveAsync().then(function () {
        _user2.default.updateAsync({ $or: [{ _id: newTripObj.riderId }, { _id: newTripObj.driverId }] }, { $set: { currTripId: newTripObj._id, currTripState: 'trip' } }, { multi: true }) //eslint-disable-line
        .then(function () {
          res.send(returnObj);
        }).error(function (e) {
...
function updateTrip(req, res, next) {
  ...
  _trip2.default.findOneAndUpdateAsync({ _id: tripId }, { $set: tripObj }, { new: 1, runValidators: true }).then(function (updatedTripObj) {
    //eslint-disable-line
    var returnObj = {
      success: false,
...
exports.default = {
  tripDetails: tripDetails, getOngoingTripDetails: getOngoingTripDetails, getRecentReviewedTripDetails: getRecentReviewedTripDetails, createNewTrip: createNewTrip, updateTrip: updateTrip, loadTripDetails: loadTripDetails, tripRevenueGraph: tripRevenueGraph, getSpecificUserTripDetails: getSpecificUserTripDetails
};
